...
class QuizVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let que1 = Question(imgName: "img1", questionText: "What is 2 x 2 ?", options: ["2", "4", "8", "6"], correctAns: 1, wrongAns: 0, isAnswered: false)
        let que2 = Question(imgName: "img2", questionText: "Look over ______.", options: ["their", "they're", "there", "IDK."], correctAns: 2, wrongAns: 0, isAnswered: false)
        let que3 = Question(imgName: "img1", questionText: "What is 6 / 2 ?", options: ["2", "4", "3", "5"], correctAns: 2, wrongAns: 0, isAnswered: false)
        let que4 = Question(imgName: "img2", questionText: "When was the war of 1812?", options: ["1918", "1812", "1775", "1498"], correctAns: 1, wrongAns: 0, isAnswered: false)
