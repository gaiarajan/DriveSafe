...
class QuizCVCell: UICollectionViewCell {
    ...
    var question: Question? {
        didSet {
            ...
            if unwrappedQue.isAnswered {
                btnsArray[unwrappedQue.correctAns].backgroundColor=UIColor(red:0.66, green:0.90, blue:0.73, alpha:1.0)
    ...
    func getButton(tag: Int) -> UIButton {
        ...
        btn.setTitleColor(UIColor(red:0.18, green:0.12, blue:0.18, alpha:1.0), for: .normal)
